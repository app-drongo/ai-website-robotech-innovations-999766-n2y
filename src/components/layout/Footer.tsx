...
const DEFAULT_FOOTER = {
  logoText: 'RoboTech',
  companyDescription:
    'Pioneering the future of robotics with cutting-edge AI and automation solutions. Join industry leaders who trust our advanced robotic systems for manufacturing, logistics, and beyond.',
  ...
  madeWithText: 'with precision engineering',
